...
{        
    ...
    {       
        ...
        for (size_t j = 0; j < 3; j++)
        {
            ...
            vertexWorldPos.z -= m_camera.m_pos.z;
...
void Application::draw()
{
    ...
    for (size_t i = 0; i < izdusumUcgenleri.size(); i++)
    {
        ...
        gp.drawFilledRectangle(trig.points[0].x, trig.points[0].y, 5, 5, m_color);
        gp.drawFilledRectangle(trig.points[1].x, trig.points[1].y, 5, 5, m_color);
        gp.drawFilledRectangle(trig.points[2].x, trig.points[2].y, 5, 5, m_color);
